              ...
              <div class="row">
                  ...
                  <div class="col-lg-12">
                   ...
                   <div class="col-lg-6 form-group required-field-block">
                      ...
                      <div class="col-md-12 input-group">
                          <span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span></span>
                          <textarea rows="5" size="100" value="" name="material_e" id="material_e" class="form-control" placeholder="Material">{if !empty ($registro)}{$registro->getMaterialReg()}{/if}</textarea>
                      </div>
                  </div>
                  <div class="col-lg-6 form-group required-field-block">
                       <label class="control-label" for="observaciones">Observaciones</label>
                      <div class="col-md-12 input-group">
                          <span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span></span>
                          <textarea rows="5" size="100" name="observaciones_e" value="" id="observaciones_e" class="form-control" placeholder="Observaciones">{if !empty ($registro)}{$registro->getObservacionesReg()}{/if}</textarea>
                      </div>
                  </div>
