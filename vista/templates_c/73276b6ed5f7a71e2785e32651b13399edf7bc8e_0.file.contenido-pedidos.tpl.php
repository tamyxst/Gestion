<?php
/* Smarty version 3.1.30, created on 2017-06-04 18:57:11
  from "/var/www/html/gestion/vista/templates/contenido-pedidos.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59343be7c92da2_97033470',
...
function content_59343be7c92da2_97033470 (Smarty_Internal_Template $_smarty_tpl) {
?>
                  ...
                  <div class="col-lg-6">
                   ...
                   <div class="col-lg-6">
                     <div class="form-group">
                          ...
                          <div class="input-group date input-append datepicker" id="filter-date">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                              <input type="text" id="fecha_entrega_e" name="fecha_entrega_e" value="<?php if (!empty($_smarty_tpl->tpl_vars['pedido']->value)) {
echo $_smarty_tpl->tpl_vars['pedido']->value->getFechaEntregaReg();
                   ...
                   <div class="col-lg-6 form-group required-field-block">
                      ...
                      <div class="col-md-12 input-group">
                          <span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span></span>
                          <textarea rows="5" size="100" value="" name="material_e" id="material_e" class="form-control" placeholder="Material"><?php if (!empty($_smarty_tpl->tpl_vars['pedido']->value)) {
echo $_smarty_tpl->tpl_vars['pedido']->value->getMaterialReg();
                  ...
                  <div class="col-lg-6 form-group required-field-block">
                      ...
                      <div class="col-md-12 input-group">
                          <span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span></span>
                          <textarea rows="5" size="100" name="observaciones_e" value="" id="observaciones_e" class="form-control" placeholder="Observaciones"><?php if (!empty($_smarty_tpl->tpl_vars['pedido']->value)) {
