<?php
/* Smarty version 3.1.30, created on 2017-06-04 18:51:49
  from "/var/www/html/gestion/vista/templates/contenido-proveedores.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59343aa532c4b2_35230884',
...
function content_59343aa532c4b2_35230884 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
" /><b><?php echo $_smarty_tpl->tpl_vars['mp']->value->getNombreContacto();?>
                                        ...
                                        <td><span class="badge bg-light-blue"><?php echo $_smarty_tpl->tpl_vars['mp']->value->getNumReg();?>
</span></td>
                                    </tr>
                                <?php
}
...
?>
              ...
              <div class="tab-pane" id="nuevo">
                <form id="formnprov" novalidate action="gestion-proveedores.php" method="post"> 
                <div class="row">
                   <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <button type="submit" name="enviar" class="btn btn-default" onsubmit="validarFormuProv()">Enviar</button> 
                        </div>  
                    </div>
                </div>
               </form>
          ...
          <div class="row">
            ...
            <form id="formeditarprov" novalidate action="gestion-proveedores.php" method="post"> 
            <div class="row">
                <div class="col-lg-6">
                   <div class="form-group">
...
echo $_smarty_tpl->tpl_vars['proveedor']->value->getIdContacto();
                        ...
                        <button type="submit" name="editar" class="btn btn-default" onsubmit="validarFormuEditarProv()">Editar proveedor</button> 
                        <!--<button type="submit" name="eliminar" name="eliminar" class="btn btn-default"><i class="fa fa-trash-o"></i> Eliminar</button>-->
                        <button type="button" name="eliminar" class="btn btn-danger remProv">Eliminar</button>
                    </div>
                </div>
            </div>
           </form>
...
?>
                                        <tr>
                                            <td><?php if (($_smarty_tpl->tpl_vars['mi']->value->getTipoReg() === 'incidencia')) {?>Incidencia<?php } elseif (($_smarty_tpl->tpl_vars['mi']->value->getTipoReg() === 'pedido')) {?>Pedido<?php } else { ?>Otro registro<?php }?></td>
                                            <td><a href="<?php if (($_smarty_tpl->tpl_vars['mi']->value->getTipoReg() === 'incidencia')) {?>gestion-incidencias.php?id=<?php } elseif (($_smarty_tpl->tpl_vars['mi']->value->getTipoReg() === 'pedido')) {?>gestion-pedidos.php?id=<?php } else { ?>gestion-registros.php?id=<?php }
echo $_smarty_tpl->tpl_vars['mi']->value->getIdReg();?>
">Ver más</a></td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['mi']->value->getIdContactoReg();?>
</td>
                                            <td><b><?php echo $_smarty_tpl->tpl_vars['mi']->value->getFechaReg();?>
</b></td>
