<?php
/* Smarty version 3.1.30, created on 2017-06-04 19:00:09
  from "/var/www/html/gestion/vista/templates/contenido-incidencias.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59343c99e86430_47959445',
...
function content_59343c99e86430_47959445 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<div class="row">
    <div class="col-lg-12">
        <h3>
        Gestión ALGO
        <small>Gestión Incidencias</small>
    </h3>
    </div>
</div>
<div class="row">
                    ...
                    <div class="col-lg-6">
                     ...
                     <div class="col-lg-6 form-group required-field-block">
                        ...
                        <div class="col-md-12 input-group">
                            ...
                            <textarea rows="5" size="1100" value="" name="material" id="material" class="form-control" placeholder="Material"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-6 form-group required-field-block">
...
?>
        ...
        <div class="row">
          ...
          <form id="formeditreg" action="gestion-incidencias.php" method="post" enctype="multipart/form-data">  
              <div class="row">
                   <div class="col-lg-6">
                     <div class="form-group">
...
echo $_smarty_tpl->tpl_vars['incidencia']->value->getIdContactoReg();
                  ...
                  <div class="col-lg-6">
                   ...
                   <div class="col-lg-6 form-group required-field-block">
                      ...
                      <div class="col-md-12 input-group">
                          <span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span></span>
                          <textarea rows="5" size="100" value="" name="material_e" id="material_e" class="form-control" placeholder="Material"><?php if (!empty($_smarty_tpl->tpl_vars['incidencia']->value)) {
echo $_smarty_tpl->tpl_vars['incidencia']->value->getMaterialReg();
                  ...
                  <div class="col-lg-6 form-group required-field-block">
                      ...
                      <div class="col-md-12 input-group">
                          <span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span></span>
                          <textarea rows="5" size="100" name="observaciones_e" value="" id="observaciones_e" class="form-control" placeholder="Observaciones"><?php if (!empty($_smarty_tpl->tpl_vars['incidencia']->value)) {
...
echo $_smarty_tpl->tpl_vars['incidencia']->value->getIdReg();
                         ...
                         <button type="submit" name="editar" class="btn btn-default">Editar Incidencia</button> 
              ...
              <div class="col-md-6">
              <h3>Comentarios <?php echo $_smarty_tpl->tpl_vars['usuario']->value;?>
</h3>
